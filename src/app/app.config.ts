...
import {
  ...
  LucideMenu, LucideRepeat, LucideShuffle, LucideLogOut, LucideUserCircle, LucideGraduationCap,
  LucideStar, LucideFilter, LucideLightbulb, LucideClock, LucideMic, LucideMicOff,
