...
export const THERAPISTS: Therapist[] = [
  ...
  createTherapist({ id: 'heena-pahuja', name: 'Heena Pahuja', image: 'assets/users/heena.avif', subtitle: 'RCI Licensed Counselling Psychologist', qualifications: ['MSc Clinical Psychology'], experienceYears: 4, price: 1500, duration: '60 mins', sessionModes: ['Video'], gender: 'female', rating: 4.8, reviews: 40, specialties: ['Relationships', 'Stress Management'], languages: ['English'], bio: "I’m Heena and my approach is simple — I try to understand what’s happening beneath the behavior, rather than looking only at the problem on the surface. Over the years, my work has involved counselling, children and adolescents, parents, educators, and working professionals. I believe psychology becomes truly useful when it connects with everyday life; our relationships, thoughts, emotions, choices, and the way we respond to people around us. Through my work, I aim to create a space where people can understand themselves better, learn practical skills, and make meaningful changes at their own pace." }, -1, 0, [1, 2, 3, 4, 5, 6]),
