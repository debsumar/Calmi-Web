  ...
  template: `
    <main class="min-h-screen bg-canvas px-6 py-10 font-sans text-ink md:px-12">
      <div class="mx-auto max-w-3xl rounded-3xl border border-hairline bg-surface p-8 shadow-card md:p-12">
        <a routerLink="/auth/login" class="text-sm font-semibold text-brand underline-offset-4 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand">Back to Login</a>
